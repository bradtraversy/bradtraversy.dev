...
**Goal**: a working Astro site at `travxlabs.com` that renders empty templates correctly.
...
- ☐ Write launch article: "Why I'm building TravxLabs"
...
- ☐ Flip `bradtraversy/travxlabs-site` repo from private → public (per Q9)
