...
it's not a research project. it's the actual setup that ships vidpipe, polishes devlog drafts, writes commit messages, and keeps the whole operation moving. the full tour is in [how the agent fleet works](/articles/how-the-agent-fleet-works).
